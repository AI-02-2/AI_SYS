...
> 안내: 본 문서는 와이어플로우와 실제 구현 화면 매핑을 함께 기록합니다.

## 구현 매핑 메모 (2026-04-17)
- Home: DB 기반 복습 대시보드 카드 로드
- OCR: PhotosPicker + Vision 인식 후 Search 탭 자동 이동
- Search/Detail: 판례 요약 카드 + 퀴즈 생성 버튼 기반 동작
- Review/My Page: 오답 리스트 확인 및 API 주소 설정 제공
- 공통 내비게이션: 주요 화면에 동일한 뒤로가기 버튼 적용
